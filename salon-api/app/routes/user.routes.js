 ...
 * /api/users:
 *   post:
 *     summary: Create a new user with optional profile photo upload
 *     tags: [Users]
 *     security:
 ...
 */
    ...
    app.post(`${apiPrefix}`, upload.single('profile_photo'), authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER), usersController.create);
 ...
 */
  ...
  app.put(`${apiPrefix}/:id`, upload.single('profile_photo'), authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER,roles.CUSTOMER),usersController.update);
    ...
    app.delete(`${apiPrefix}/:id`, authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER,roles.CUSTOMER), usersController.delete);
   ...
   */
   ...
   // Route to retrieve users with pagination and filters
    app.get(`${apiPrefix}`, authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER),usersController.getAllUsers);

 ...
 */
    ...
    app.post(`${apiPrefix}`, authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER,roles.BARBER),haircutDetailsController.create);
    ...
    app.put(`${apiPrefix}/:id`, authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER,roles.BARBER),haircutDetailsController.update);
    ...
    app.delete(`${apiPrefix}/:id`,authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER,roles.BARBER), haircutDetailsController.delete);
};

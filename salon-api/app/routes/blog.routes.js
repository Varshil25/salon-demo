...
module.exports = app => {
    ...
    app.post(`${apiPrefix}`, upload.single('image'),  authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER),blogsController.create);
    ...
    app.put(`${apiPrefix}/:id`, upload.single('image'), authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER),blogsController.update);
    ...
    app.delete(`${apiPrefix}/:id`, authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER), blogsController.delete);

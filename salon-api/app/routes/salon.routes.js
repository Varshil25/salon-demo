 ...
 */
  app.post(`${apiPrefix}`, upload.array('photos', 5), authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER),salonController.create);
   ...
   *                   example: "An error occurred while fetching salons"
   */
  app.get(`${apiPrefix}/admin`, [authenticateToken], salonController.adminSalonfindAll);
 ...
 */
  ...
  app.put(`${apiPrefix}/:id`, upload.array('photos', 5), authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER), salonController.update);
  ...
  app.delete(`${apiPrefix}/:id`, authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER), salonController.delete);
 ...
 */
  ...
  app.patch(`${apiPrefix}/status/:id`, authenticateJWT, authorizeRoles(roles.ADMIN, roles.SALON_OWNER), salonController.updateStatus);

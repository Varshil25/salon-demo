...
import { AllPickeringBarbers } from "../../../common/data/pagesData";
import AboutusImage from "../../../assets/images/Gallery/Gallery_Bg.jpeg";
import { AllBarbers } from "../../../common/data/pagesData"; // Ensure correct import
import Navbar from "../HomePage/Navbar";
import Footer from "../HomePage/Footer";

const Pickeringbarber = () => {
  return (
    <>
      <Navbar />
      {/* Hero Section */}
        ...
        <div className="containers">
          ...
          <div className="container">
            <div className="row mt-5 ">
              {AllPickeringBarbers.map((member, index) => (
...
export default Pickeringbarber;

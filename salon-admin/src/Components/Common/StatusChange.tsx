...
import { fetchSalons, updateSalonStatus } from "../../Services/SalonService"; // Assuming the API function is in api.js or api.ts
...
const SalonStatusDropdown = ({ isSalonOwner, userInfo, salonUserInfo, showLoader }: SalonStatusDropdownProps) => {

...
const projects = [
    ...
    {
        id: 4,
        title: "Shear Brilliance Project",
...
const documents = [
    ...
    },
    {
        ...
        iconBackgroundClass: "danger",
        fileName: "Shear Brilliance-logo.png",
        fileType: "PNG File",
        fileSize: "879 KB",
...
const video = [
    {
        id: 1,
        title: "Admin dashboard templates - Material Design for Shear Brilliance",
        siteLink: "https://themesbrand.com/velzon/index.html",
        videoLink: "https://www.youtube.com/embed/GfSZtaoc5bw",
        description: "Shear Brilliance admin is super flexible, powerful, clean, modern & responsive admin template based on bootstrap 5 stable with unlimited possibilities. You can simply change to any layout or mode by changing a couple of lines of code. You can start small and large projects or update design in your existing project using Shear Brilliance it is very quick and easy as it is beautiful, adroit, and delivers the ultimate user experience.",
        likes: 335,
        comments: 102,
        auther: "Themesbrand"
    },
    ...
    {
        id: 3,
        title: "Shear Brilliance - The Most Popular Bootstrap 5 HTML, Angular & React Js Admin",
        siteLink: "https://themesbrand.com/velzon/index.html",

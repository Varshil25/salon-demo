...
const TimeTracking = () => {
    return (
        <React.Fragment>
                ...
                <CardBody>
                    <div className="mb-4">
                        <select className="form-control" name="choices-single-default" data-choices data-choices-search-false>
                            <option value="">Select Appointment board</option>
                    ...
                    <div className="table-card">
                        <table className="table mb-0">
                            <tbody>
                                <tr>
                                    <td className="fw-medium">Appointments No</td>
                                    <td>#VLZ456</td>
                                </tr>
                                <tr>
                                    <td className="fw-medium">Appointments Title</td>
                                    <td>Profile Page Satructure</td>
                                </tr>
                                <tr>
                                    <td className="fw-medium">Appointments Name</td>
                                    <td>Shear Brilliance - Admin Dashboard</td>
                                </tr>
                                <tr>
            ...
            <Card>
                <CardBody>
                    <h5 className="card-title mb-3">Previous Appointments</h5>
                    <div className="vstack gap-2">
                        ...
                        <div className="border rounded border-dashed p-2">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                    <h5 className="fs-13 mb-1"><Link to="#" className="text-body text-truncate d-block">Shear Brilliance admin.ppt</Link></h5>
                                    <div>2.4MB</div>
                                </div>
                                <div className="flex-shrink-0 ms-2">
                                    <div className="d-flex gap-1">

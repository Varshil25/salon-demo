...
const Timeline = () => {
    ...
    document.title = "Timeline | Shear Brilliance - Admin Dashboard";
                                ...
                                <div className="timeline">
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <p className="text-muted">Every team project can have a Shear Brilliance. Use the Shear Brilliance to share information with your team to understand and contribute to your project.</p>
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            <h5>Shear Brilliance admin dashboard layout upload</h5>
                                    ...
                                    <div className="timeline-continue">
                                        ...
                                        <Row className="timeline-right">
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box">
                                                    <div className="timeline-text">
                                                        <h5>Shear Brilliance - Project Discussion</h5>

...
const SalonTermsCondition = () => {
  document.title = "Salon Terms & Conditions | Shear Brilliance";
  return (
    <>
    
    <Container style={{ marginTop: "80px" }} className="form-control">
      <h1 className="text-center font-weight-bold">Shear Brilliance</h1>
      <Row className="mt-1">
        <Col xs={12} className="text-center">
          <h1>END USER LICENSE AGREEMENT (EULA)</h1>
          <h3>Shear Brilliance Terms Of Use</h3>
          <p>
        ...
        <Col xs={12}>
          <p>
            Shear Brilliance is governed by our Terms of Use (EULA). Please
          ...
          <p>
            ...
            the Shear Brilliance platform (the "Platform") operated by Shear
            Brilliance ("us," "we," or "our"). These Terms govern your access
        ...
        <Col xs={12}>
          ...
          <p>
            ...
            owned or licensed by Shear Brilliance and are protected by
          ...
          <p>
            ...
            software, are owned or licensed by Shear Brilliance and are
          ...
          <p>
            To the maximum extent permitted by law, Shear Brilliance and its
            ...
            the Platform or these Terms, even if Shear Brilliance has been

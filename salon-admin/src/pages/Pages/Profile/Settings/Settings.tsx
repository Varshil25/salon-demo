...
const Settings: React.FC = () => {
    ...
    document.title = "Profile Settings | Shear Brilliance Admin";
    useEffect(() => {
    ...
    const changePasswordSchema = Yup.object().shape({
        oldpassword: Yup.string().required("Old Passord is required"),
        newpassword: Yup.string().required("Last name is required"),
        confirmpassword: Yup.string()
            .oneOf([Yup.ref('newpassword'), ""], 'Passwords must match') // Match validation

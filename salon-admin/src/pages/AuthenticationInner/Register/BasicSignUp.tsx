...
const BasicSignUp = () => {
    document.title = "Basic SignUp | Shear Brilliance - Admin Dashboard";
                                    ...
                                    <CardBody className="p-4">
                                        <div className="p-2 mt-4">
                                            <Form onSubmit={(e) => {
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Shear Brilliance

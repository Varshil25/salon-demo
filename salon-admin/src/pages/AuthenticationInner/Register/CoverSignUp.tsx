...
const CoverSignUp = () => {
    document.title = "Cover SignUp | Shear Brilliance - Admin Dashboard";
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="text-center">
                                    <p className="mb-0">{new Date().getFullYear()} Shear Brilliance. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                </div>
                            </div>
                        </div>
                    </Container>

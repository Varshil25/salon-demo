...
const ToDoList = () => {
    document.title = "To Do Lists | Shear Brilliance - Admin Dashboard";
                        ...
                        <div className="file-manager-content w-100 p-4 pb-0">
                            <Row className="mb-4">
                                ...
                                <div className="col-sm order-3 order-sm-2 mt-3 mt-sm-0">
                                    <h5 className="fw-semibold mb-0">Shear Brilliance - Admin Dashboard <span className="badge bg-primary align-bottom ms-2">v1.0.0</span></h5>
                                </div>
